...
public class GetApplicationListAsThirdPartyClient extends BaseApplicantClient {
	
	private static final String CLASSNAME = GetApplicationListAsThirdPartyClient.class.getSimpleName();
	...
	public static void main( String[] args ) {
		...
		try {
			GetApplicationListAsThirdPartyClient client = new GetApplicationListAsThirdPartyClient();
	...
	public void makeServiceCall() throws Exception {
		try {
			...
			GetApplicationListAsThirdPartyRequest request = new GetApplicationListAsThirdPartyRequest();
			...
			GetApplicationListAsThirdPartyResponse response = port.getApplicationListAsThirdParty( request );
